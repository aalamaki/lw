<?php
// $Id: page.tpl.php,v 1.2.2.6 2008/11/22 08:23:32 hswong3i Exp $
...
<div id="container" class="clear-block"><!-- begin container -->
  <div id="header"><!-- begin header -->
    ...
    <?php } ?>
	<div style="width: 1024px; margin-left: 300px; text-align: center; margin-top: 55px;"><?php print $header ?></div>
  </div><!-- end header -->
  ...
  <div id="breadcrumb-search"><div class="right-corner"><div class="left-corner">
    ...
    <?php if ($search_box): ?><div style="position: relative; top: -100px;"><?php print $search_box ?></div><?php endif; ?>
  </div></div></div>
