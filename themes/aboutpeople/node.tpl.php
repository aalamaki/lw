  ...
  <div class="node<?php if ($sticky) { print " sticky"; } ?><?php if (!$status) { print " node-unpublished"; } ?>">
	...
	<?php global $base_url;
	if ($sticky) { print '<img src="'.base_path(). drupal_get_path('theme','aboutpeople').'/img/sticky.gif" alt="sticky icon" class="sticky" />'; } ?>
	</h2><?php }; ?>
	<?php if (!$teaser): ?>
	<?php if ($submitted): ?>
    ...
    <?php endif; ?>
    <?php if (!$teaser): ?>
    <?php if ($terms) { ?><div class="taxonomy"><span>..</span> <?php print $terms?></div><?php } ?>
    <?php endif; ?>
  </div>
